# Slice 1 phase 3 — WV1025929 activation chain

**Started:** 2026-07-03T17:21:26.335Z
**Finished:** 2026-07-03T17:22:21.836Z
...
| WV1025929 off top gap list | No — WV1025929 still ranked #2 |
| Scoped detect | Ran slice3-echo-batch-detect --permit WV1025929 |
...
npm run qa:slice1-seed-exceedances -- --limit 50 --batches 20 --permit WV1025929
npm run qa:slice1-repair-stuck-keys -- --limit 50 --batches 10 --permit WV1025929
npm run qa:slice1-reconcile -- --limit 10000 --batches 10
npm run qa:slice1-activation-gaps -- --suffix after
npm run qa:slice3-echo-batch-detect -- --permit WV1025929 --wait 20
```
