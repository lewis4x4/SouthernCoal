# Slice 1 phase 3 — WV1021249 activation chain

**Started:** 2026-07-03T17:24:36.320Z
**Finished:** 2026-07-03T17:25:31.624Z
...
| WV1021249 off top gap list | No — WV1021249 still ranked #6 |
| Scoped detect | Ran slice3-echo-batch-detect --permit WV1021249 |
...
npm run qa:slice1-seed-exceedances -- --limit 50 --batches 20 --permit WV1021249
npm run qa:slice1-repair-stuck-keys -- --limit 50 --batches 10 --permit WV1021249
npm run qa:slice1-reconcile -- --limit 10000 --batches 10
npm run qa:slice1-activation-gaps -- --suffix after
npm run qa:slice3-echo-batch-detect -- --permit WV1021249 --wait 20
```
