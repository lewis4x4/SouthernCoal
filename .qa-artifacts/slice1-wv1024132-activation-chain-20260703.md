# Slice 1 phase 3 — WV1024132 activation chain

**Started:** 2026-07-03T17:23:33.026Z
**Finished:** 2026-07-03T17:24:28.585Z
...
| WV1024132 off top gap list | No — WV1024132 still ranked #5 |
| Scoped detect | Ran slice3-echo-batch-detect --permit WV1024132 |
...
npm run qa:slice1-seed-exceedances -- --limit 50 --batches 20 --permit WV1024132
npm run qa:slice1-repair-stuck-keys -- --limit 50 --batches 10 --permit WV1024132
npm run qa:slice1-reconcile -- --limit 10000 --batches 10
npm run qa:slice1-activation-gaps -- --suffix after
npm run qa:slice3-echo-batch-detect -- --permit WV1024132 --wait 20
```
