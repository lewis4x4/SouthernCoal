-- =============================================================================
-- Migration 005: Add corrective action audit actions
-- =============================================================================
-- Expands audit_log CHECK constraint for CA workflow tracking
-- =============================================================================
...
ALTER TABLE audit_log ADD CONSTRAINT audit_log_action_check CHECK (
  action = ANY (ARRAY[
    ...
    -- Layer 2: External sync operations
    'external_sync_started'::text,
    'external_sync_completed'::text,
    'external_sync_failed'::text,
    -- Layer 2: Discrepancy triage
    'discrepancy_detected'::text,
    'discrepancy_reviewed'::text,
    'discrepancy_dismissed'::text,
    'discrepancy_escalated'::text,
    'discrepancy_resolved'::text,
    -- NEW: Corrective Action workflow
    'corrective_action_created'::text,
    'corrective_action_assigned'::text,
    'corrective_action_step_advanced'::text,
    'corrective_action_step_data_updated'::text,
    'corrective_action_signed'::text,
    'corrective_action_approved'::text,
    'corrective_action_closed'::text,
    'corrective_action_reopened'::text,
    'corrective_action_pdf_generated'::text,
    'corrective_action_exported'::text
  ])
);
