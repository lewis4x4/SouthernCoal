...
- [x] Slice 1 phase 3 activation chain and WV batch runner — single-permit chain now requires `--permit`; WV batch dry-run selected the next five WV missing-limit permits and preserved prior chain skips (artifact `.qa-artifacts/slice1-wv-batch-activation-20260703t173909z.md`)
