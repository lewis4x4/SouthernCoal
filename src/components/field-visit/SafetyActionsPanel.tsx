...
export function SafetyActionsPanel({
  ...
  return (
    <div className="rounded-2xl border border-qo-risk/25 bg-qo-risk/10 p-5">
      <div className="flex items-center gap-2">
        <ShieldAlert className="h-4 w-4 text-qo-risk" aria-hidden />
        <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-qo-risk">
          Safety actions
        </h3>
      </div>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        <button
          ...
          className="rounded-xl border border-qo-risk/20 bg-white px-4 py-4 text-left transition-colors hover:bg-qo-risk/5 disabled:opacity-60"
        >
          <AlertTriangle className="h-4 w-4 text-qo-risk" aria-hidden />
        ...
        <button
          ...
          className="rounded-xl border border-qo-risk/20 bg-white px-4 py-4 text-left transition-colors hover:bg-qo-risk/5 disabled:opacity-60"
        >
          <UserRound className="h-4 w-4 text-qo-risk" aria-hidden />
