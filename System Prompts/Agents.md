...
This mission is a release gate.

## Autonomous Build Contract

This repository is operated as an autonomous engineering system.
...
4. Commit atomically.
5. Push.
6. Start the next segment immediately.
...
- No “done” status without passing required gates
- No mixed-purpose commits
- No stopping after push unless explicitly instructed
- Mission misalignment can block release even if tests pass
- Security and workspace boundaries are validated before ship, not after release
